...
router.post('/:id/follow', asyncHandler(authenticate), asyncHandler(followsController.follow));
router.delete('/:id/follow', asyncHandler(authenticate), asyncHandler(followsController.unfollow));
